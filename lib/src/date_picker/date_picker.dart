...
class SfDateRangePicker extends StatelessWidget {
  ...
  SfDateRangePicker(
      ...
      : assert(headerHeight >= -1),
        assert(
            minDate == null || maxDate == null || minDate.isBefore(maxDate) || minDate == maxDate),
...
class _SfDateRangePickerState extends State<_SfDateRangePicker>
  ...
  SfDateRangePickerThemeData _getPickerThemeData(
    ...
    final SfDateRangePickerThemeData effectiveThemeData = SfDateRangePickerThemeKey(context);
    return pickerTheme.copyWith(
        brightness: themeData.brightness,
        backgroundColor: pickerTheme.backgroundColor ?? effectiveThemeData.backgroundColor,
        headerBackgroundColor:
            pickerTheme.headerBackgroundColor ?? effectiveThemeData.headerBackgroundColor,
        viewHeaderBackgroundColor:
            pickerTheme.viewHeaderBackgroundColor ?? effectiveThemeData.viewHeaderBackgroundColor,
        weekNumberBackgroundColor:
            pickerTheme.weekNumberBackgroundColor ?? effectiveThemeData.weekNumberBackgroundColor,
        ...
        startRangeSelectionColor:
            pickerTheme.startRangeSelectionColor ?? effectiveThemeData.startRangeSelectionColor,
        rangeSelectionColor:
            pickerTheme.rangeSelectionColor ?? effectiveThemeData.rangeSelectionColor,
        endRangeSelectionColor:
            pickerTheme.endRangeSelectionColor ?? effectiveThemeData.endRangeSelectionColor,
        todayHighlightColor:
            pickerTheme.todayHighlightColor ?? effectiveThemeData.todayHighlightColor);
  }
